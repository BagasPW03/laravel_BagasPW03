...
<div class="container">
  <div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
      <h5 class="m-0">Tambah Rumah Sakit</h5>
    </div>

    <div class="card-body">
      <form action="/rumahsakit" method="POST" enctype="multi">
        @csrf

        <div class="mb-3">
          <label for="nama" class="form-label">Nama Rumah Sakit <span class="text-danger">*</span></label>
          <input type="text" name="nama_rumah_sakit" id="nama_rumah_sakit" class="form-control"
